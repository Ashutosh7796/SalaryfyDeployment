...
public class AppConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .requestMatchers("/jobFairOption/**").hasAuthority("USER")
                .requestMatchers("/JobFair/**").hasAuthority("USER")
                .requestMatchers("/ESuggest/**").hasAuthority("USER")
                .requestMatchers("/Interview/**").hasAuthority("USER")
                .requestMatchers("/profileLevel/**").hasAuthority("USER")
                .requestMatchers("/verification/**").permitAll()
                .requestMatchers("/company/**").hasAuthority("USER")
                .requestMatchers("/experience/**").hasAuthority("USER")
                .requestMatchers("/jobFairQueAns/**").hasAuthority("USER")
                .requestMatchers("/uploadFile/**").hasAuthority("USER")

                .requestMatchers("/jobFairOption/**").hasAuthority("USER")
                .requestMatchers("/job/**").hasAuthority("USER")
                .requestMatchers("/jobs/**").hasAuthority("USER")
                .requestMatchers("/pdf/**").hasAuthority("USER")
                .requestMatchers("/plan/**").hasAuthority("USER")
                .requestMatchers("/pgProgram/**").hasAuthority("USER")
                .requestMatchers("/userSkill/**").hasAuthority("USER")
